...
namespace Bix.IO.WebApi
{
    ...
    public abstract class AuthenticatedDataSinkControllerBase : AuthenticatedBixControllerBase
    {
        /// <summary>
        ...
        public AuthenticatedDataSinkControllerBase(IHttpContextAccessor httpContextAccessor, ILogger logger)
        {
